...
if TYPE_CHECKING:
    from app.schemas.Booking_Ticket import BookingTicketInDB  # tương ứng với PhieuDatChoVeMayBayInDB

class EmployeeBase(BaseModel):
    employee_id: str
    employee_username: str = Field(..., min_length=3, max_length=200)
    employee_password: str = Field(..., min_length=6, max_length=200)
...
class EmployeeUpdate(BaseModel):
    ...
    employee_password: str | None = Field(None, min_length=6, max_length=200)
