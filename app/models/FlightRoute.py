...
class FlightRoute(Base):
    ...
    departure_airport_id = Column(String(50), ForeignKey("airport.airport_id"), nullable=True)
    arrival_airport_id = Column(String(50), ForeignKey("airport.airport_id"), nullable=True)
