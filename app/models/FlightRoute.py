...
class FlightRoute(Base):
    ...
    flights = relationship("Flight", back_populates="flight_route")
    flight_details = relationship("FlightDetail", back_populates="flight_route")
    ticket_prices = relationship("TicketPrice", back_populates="flight_route")